...
r#""This is a multiline string with a continuation here, \
    ...
    fn test_issue_test_smptd() {
        ...
        test_token_w_position!(tokens[12], TType::String, (2, 20), (2, 35), "b'EHLO example'" );
        test_token_w_position!(tokens[13], TType::Op, (2, 35), (2, 36), ")" );
        test_token_w_position!(tokens[14], TType::NL, (2, 36), (2, 36), "" );
        test_token_w_position!(tokens[15], TType::Name, (3, 4), (3, 8), "self" );
        test_token_w_position!(tokens[16], TType::Op, (3, 8), (3, 9), "." );
        test_token_w_position!(tokens[17], TType::Name, (3, 9), (3, 19), "write_line" );
        test_token_w_position!(tokens[18], TType::Op, (3, 19), (3, 20), "(" );
        //test_token_w_position!(tokens[19], TType::String, (4, 8), (4, 64), r#"'MAIL From: naiÌˆve@examplÃ© BODY=8BITMIME SMTPUTF8'"# );
        test_token_w_position!(tokens[20], TType::Op, (4, 64), (4, 65), "." );
        test_token_w_position!(tokens[21], TType::Name, (4, 65), (4, 71), "encode" );
        test_token_w_position!(tokens[22], TType::Op, (4, 71), (4, 72), "(" );
        test_token_w_position!(tokens[23], TType::String, (4, 72), (4, 79), "'utf-8'" );
        test_token_w_position!(tokens[24], TType::Op, (4, 79), (4, 80), ")" );
        test_token_w_position!(tokens[25], TType::Op, (4, 80), (4, 81), ")" );
        test_token_w_position!(tokens[26], TType::NL, (4, 81), (4, 81), "" );
        test_token_w_position!(tokens[27], TType::Name, (5, 4), (5, 8), "self" );
        test_token_w_position!(tokens[28], TType::Op, (5, 8), (5, 9), "." );
        test_token_w_position!(tokens[29], TType::Name, (5, 9), (5, 20), "assertEqual" );
        test_token_w_position!(tokens[30], TType::Op, (5, 20), (5, 21), "(" );
        test_token_w_position!(tokens[31], TType::Name, (5, 21), (5, 25), "self" );
        test_token_w_position!(tokens[32], TType::Op, (5, 25), (5, 26), "." );
        test_token_w_position!(tokens[33], TType::Name, (5, 26), (5, 33), "channel" );
        test_token_w_position!(tokens[34], TType::Op, (5, 33), (5, 34), "." );
        test_token_w_position!(tokens[35], TType::Name, (5, 34), (5, 40), "socket" );
        test_token_w_position!(tokens[36], TType::Op, (5, 40), (5, 41), "." );
        test_token_w_position!(tokens[37], TType::Name, (5, 41), (5, 45), "last" );
        test_token_w_position!(tokens[38], TType::Op, (5, 45), (5, 46), "[" );
        test_token_w_position!(tokens[39], TType::Number, (5, 46), (5, 47), "0" );
        test_token_w_position!(tokens[40], TType::Op, (5, 47), (5, 48), ":" );
        test_token_w_position!(tokens[41], TType::Number, (5, 48), (5, 49), "3" );
        test_token_w_position!(tokens[42], TType::Op, (5, 49), (5, 50), "]" );
        test_token_w_position!(tokens[43], TType::Op, (5, 50), (5, 51), "," );
        test_token_w_position!(tokens[44], TType::String, (5, 52), (5, 58), "b'250'" );
        test_token_w_position!(tokens[45], TType::Op, (5, 58), (5, 59), ")" );
        test_token_w_position!(tokens[46], TType::NL, (5, 59), (5, 59), "" );
        test_token_w_position!(tokens[47], TType::Name, (6, 4), (6, 8), "self" );
        test_token_w_position!(tokens[48], TType::Op, (6, 8), (6, 9), "." );
        test_token_w_position!(tokens[49], TType::Name, (6, 9), (6, 19), "write_line" );
        test_token_w_position!(tokens[50], TType::Op, (6, 19), (6, 20), "(" );
        test_token_w_position!(tokens[51], TType::String, (6, 20), (6, 48), "'RCPT To:spÃ¤m@examplÃ©'" );
        test_token_w_position!(tokens[52], TType::Op, (6, 48), (6, 49), "." );
        test_token_w_position!(tokens[53], TType::Name, (6, 49), (6, 55), "encode" );
        test_token_w_position!(tokens[54], TType::Op, (6, 55), (6, 56), "(" );
        test_token_w_position!(tokens[55], TType::String, (6, 56), (6, 63), "'utf-8'" );
        test_token_w_position!(tokens[56], TType::Op, (6, 63), (6, 64), ")" );
        test_token_w_position!(tokens[57], TType::Op, (6, 64), (6, 65), ")" );
        test_token_w_position!(tokens[58], TType::NL, (6, 65), (6, 65), "" );
        test_token_w_position!(tokens[59], TType::Name, (7, 4), (7, 8), "self" );
        test_token_w_position!(tokens[60], TType::Op, (7, 8), (7, 9), "." );
        test_token_w_position!(tokens[61], TType::Name, (7, 9), (7, 20), "assertEqual" );
        test_token_w_position!(tokens[62], TType::Op, (7, 20), (7, 21), "(" );
        test_token_w_position!(tokens[63], TType::Name, (7, 21), (7, 25), "self" );
        test_token_w_position!(tokens[64], TType::Op, (7, 25), (7, 26), "." );
        test_token_w_position!(tokens[65], TType::Name, (7, 26), (7, 33), "channel" );
        test_token_w_position!(tokens[66], TType::Op, (7, 33), (7, 34), "." );
        test_token_w_position!(tokens[67], TType::Name, (7, 34), (7, 40), "socket" );
        test_token_w_position!(tokens[68], TType::Op, (7, 40), (7, 41), "." );
        test_token_w_position!(tokens[69], TType::Name, (7, 41), (7, 45), "last" );
        test_token_w_position!(tokens[70], TType::Op, (7, 45), (7, 46), "[" );
        test_token_w_position!(tokens[71], TType::Number, (7, 46), (7, 47), "0" );
        test_token_w_position!(tokens[72], TType::Op, (7, 47), (7, 48), ":" );
        test_token_w_position!(tokens[73], TType::Number, (7, 48), (7, 49), "3" );
        test_token_w_position!(tokens[74], TType::Op, (7, 49), (7, 50), "]" );
        test_token_w_position!(tokens[75], TType::Op, (7, 50), (7, 51), "," );
        test_token_w_position!(tokens[76], TType::String, (7, 52), (7, 58), "b'250'" );
        test_token_w_position!(tokens[77], TType::Op, (7, 58), (7, 59), ")" );
        test_token_w_position!(tokens[78], TType::NL, (7, 59), (7, 59), "" );
        test_token_w_position!(tokens[79], TType::Name, (8, 4), (8, 8), "self" );
        test_token_w_position!(tokens[80], TType::Op, (8, 8), (8, 9), "." );
        test_token_w_position!(tokens[81], TType::Name, (8, 9), (8, 19), "write_line" );
        test_token_w_position!(tokens[82], TType::Op, (8, 19), (8, 20), "(" );
        test_token_w_position!(tokens[83], TType::String, (8, 20), (8, 27), "b'DATA'" );
        test_token_w_position!(tokens[84], TType::Op, (8, 27), (8, 28), ")" );
        test_token_w_position!(tokens[85], TType::NL, (8, 28), (8, 28), "" );
        test_token_w_position!(tokens[86], TType::Name, (9, 4), (9, 8), "self" );
        test_token_w_position!(tokens[87], TType::Op, (9, 8), (9, 9), "." );
        test_token_w_position!(tokens[88], TType::Name, (9, 9), (9, 20), "assertEqual" );
        test_token_w_position!(tokens[89], TType::Op, (9, 20), (9, 21), "(" );
        test_token_w_position!(tokens[90], TType::Name, (9, 21), (9, 25), "self" );
        test_token_w_position!(tokens[91], TType::Op, (9, 25), (9, 26), "." );
        test_token_w_position!(tokens[92], TType::Name, (9, 26), (9, 33), "channel" );
        test_token_w_position!(tokens[93], TType::Op, (9, 33), (9, 34), "." );
        test_token_w_position!(tokens[94], TType::Name, (9, 34), (9, 40), "socket" );
        test_token_w_position!(tokens[95], TType::Op, (9, 40), (9, 41), "." );
        test_token_w_position!(tokens[96], TType::Name, (9, 41), (9, 45), "last" );
        test_token_w_position!(tokens[97], TType::Op, (9, 45), (9, 46), "[" );
        test_token_w_position!(tokens[98], TType::Number, (9, 46), (9, 47), "0" );
        test_token_w_position!(tokens[99], TType::Op, (9, 47), (9, 48), ":" );
        test_token_w_position!(tokens[100], TType::Number, (9, 48), (9, 49), "3" );
        test_token_w_position!(tokens[101], TType::Op, (9, 49), (9, 50), "]" );
        test_token_w_position!(tokens[102], TType::Op, (9, 50), (9, 51), "," );
        test_token_w_position!(tokens[103], TType::String, (9, 52), (9, 58), "b'354'" );
        test_token_w_position!(tokens[104], TType::Op, (9, 58), (9, 59), ")" );
        test_token_w_position!(tokens[105], TType::NL, (9, 59), (9, 59), "" );
        test_token_w_position!(tokens[106], TType::Name, (10, 4), (10, 8), "self" );
        test_token_w_position!(tokens[107], TType::Op, (10, 8), (10, 9), "." );
        test_token_w_position!(tokens[108], TType::Name, (10, 9), (10, 19), "write_line" );
        test_token_w_position!(tokens[109], TType::Op, (10, 19), (10, 20), "(" );
        test_token_w_position!(tokens[110], TType::String, (10, 20), (10, 67), r#"b'utf8 enriched text: \xc5\xbc\xc5\xba\xc4\x87'"#  );
        test_token_w_position!(tokens[111], TType::Op, (10, 67), (10, 68), ")" );
        test_token_w_position!(tokens[112], TType::NL, (10, 68), (10, 68), "" );
        test_token_w_position!(tokens[113], TType::Name, (11, 4), (11, 8), "self" );
        test_token_w_position!(tokens[114], TType::Op, (11, 8), (11, 9), "." );
        test_token_w_position!(tokens[115], TType::Name, (11, 9), (11, 19), "write_line" );
        test_token_w_position!(tokens[116], TType::Op, (11, 19), (11, 20), "(" );
        test_token_w_position!(tokens[117], TType::String, (11, 20), (11, 24), "b'.'" );
        test_token_w_position!(tokens[118], TType::Op, (11, 24), (11, 25), ")" );
        test_token_w_position!(tokens[119], TType::NL, (11, 25), (11, 25), "" );
        test_token_w_position!(tokens[120], TType::Name, (12, 4), (12, 8), "self" );
        test_token_w_position!(tokens[121], TType::Op, (12, 8), (12, 9), "." );
        test_token_w_position!(tokens[122], TType::Name, (12, 9), (12, 20), "assertEqual" );
        test_token_w_position!(tokens[123], TType::Op, (12, 20), (12, 21), "(" );
        test_token_w_position!(tokens[124], TType::Name, (13, 8), (13, 12), "self" );
        test_token_w_position!(tokens[125], TType::Op, (13, 12), (13, 13), "." );
        test_token_w_position!(tokens[126], TType::Name, (13, 13), (13, 20), "channel" );
        test_token_w_position!(tokens[127], TType::Op, (13, 20), (13, 21), "." );
        test_token_w_position!(tokens[128], TType::Name, (13, 21), (13, 34), "received_data" );
        test_token_w_position!(tokens[129], TType::Op, (13, 34), (13, 35), "," );
        test_token_w_position!(tokens[130], TType::String, (14, 8), (14, 55), r#"b'utf8 enriched text: \xc5\xbc\xc5\xba\xc4\x87'"#  );
        test_token_w_position!(tokens[131], TType::Op, (14, 55), (14, 56), ")" );
        test_token_w_position!(tokens[132], TType::NL, (14, 56), (14, 56), "" );
        test_token_w_position!(tokens[133], TType::Dedent, (14, 0), (14, 0), "" );
