...
to see if it works""""#.to_string();
    ...
    fn test_basic_class() {
        ...
        // TODO fix parser test_token_w_position!(tokens[4], TType::Newline, (12, 1), (13, 1), "\n" );
        test_token_w_position!(tokens[5], TType::Indent, (0, 2), (4, 2), "    " );
        // test_token_w_position!(tokens[6], TType::String, (4, 2), (7, 4), r#"""""\nA basic class definition\n"""""#  );
        // TODO fix parsertest_token_w_position!(tokens[7], TType::Newline, (7, 4), (8, 4), "\n" );
        // TODO fix parsertest_token_w_position!(tokens[8], TType::NL, (0, 5), (1, 5), "\n" );
        test_token_w_position!(tokens[9], TType::Name, (4, 6), (7, 6), "def" );
        test_token_w_position!(tokens[10], TType::Name, (8, 6), (16, 6), "__init__" );
        test_token_w_position!(tokens[11], TType::Op, (16, 6), (17, 6), "(" );
        test_token_w_position!(tokens[12], TType::Name, (17, 6), (21, 6), "self" );
        test_token_w_position!(tokens[13], TType::Op, (21, 6), (22, 6), ")" );
        test_token_w_position!(tokens[14], TType::Op, (22, 6), (23, 6), ":" );
        test_token_w_position!(tokens[15], TType::Newline, (23, 6), (24, 6), "\n" );
        test_token_w_position!(tokens[16], TType::Indent, (0, 7), (8, 7), "        " );
        // test_token_w_position!(tokens[17], TType::String, (8, 7), (11, 9), r#"""""\nA basic init\n"""""#  );
        test_token_w_position!(tokens[18], TType::Newline, (11, 9), (12, 9), "\n" );
        test_token_w_position!(tokens[19], TType::Name, (8, 10), (12, 10), "self" );
        test_token_w_position!(tokens[20], TType::Op, (12, 10), (13, 10), "." );
        test_token_w_position!(tokens[21], TType::Name, (13, 10), (14, 10), "c" );
        test_token_w_position!(tokens[22], TType::Op, (15, 10), (16, 10), "=" );
        test_token_w_position!(tokens[23], TType::Number, (17, 10), (18, 10), "0" );
        test_token_w_position!(tokens[24], TType::Newline, (18, 10), (19, 10), "\n" );
        test_token_w_position!(tokens[25], TType::NL, (0, 11), (1, 11), "\n" );
        test_token_w_position!(tokens[26], TType::Dedent, (4, 12), (4, 12), "" );
        test_token_w_position!(tokens[27], TType::Name, (4, 12), (7, 12), "def" );
        test_token_w_position!(tokens[28], TType::Name, (8, 12), (11, 12), "add" );
        test_token_w_position!(tokens[29], TType::Op, (11, 12), (12, 12), "(" );
        test_token_w_position!(tokens[30], TType::Name, (12, 12), (16, 12), "self" );
        test_token_w_position!(tokens[31], TType::Op, (16, 12), (17, 12), "," );
        test_token_w_position!(tokens[32], TType::Name, (18, 12), (19, 12), "a" );
        test_token_w_position!(tokens[33], TType::Op, (19, 12), (20, 12), "," );
        test_token_w_position!(tokens[34], TType::Name, (21, 12), (22, 12), "b" );
        test_token_w_position!(tokens[35], TType::Op, (22, 12), (23, 12), ")" );
        test_token_w_position!(tokens[36], TType::Op, (23, 12), (24, 12), ":" );
        test_token_w_position!(tokens[37], TType::Newline, (24, 12), (25, 12), "\n" );
        test_token_w_position!(tokens[38], TType::Indent, (0, 13), (8, 13), "        " );
        test_token_w_position!(tokens[39], TType::Name, (8, 13), (12, 13), "self" );
        test_token_w_position!(tokens[40], TType::Op, (12, 13), (13, 13), "." );
        test_token_w_position!(tokens[41], TType::Name, (13, 13), (14, 13), "c" );
        test_token_w_position!(tokens[42], TType::Op, (15, 13), (16, 13), "=" );
        test_token_w_position!(tokens[43], TType::Name, (17, 13), (18, 13), "a" );
        test_token_w_position!(tokens[44], TType::Op, (19, 13), (20, 13), "+" );
        test_token_w_position!(tokens[45], TType::Name, (21, 13), (22, 13), "b" );
        test_token_w_position!(tokens[46], TType::Newline, (22, 13), (23, 13), "\n" );
        test_token_w_position!(tokens[47], TType::NL, (0, 14), (1, 14), "\n" );
        test_token_w_position!(tokens[48], TType::Dedent, (4, 15), (4, 15), "" );
        test_token_w_position!(tokens[49], TType::Name, (4, 15), (7, 15), "def" );
        test_token_w_position!(tokens[50], TType::Name, (8, 15), (11, 15), "get" );
        test_token_w_position!(tokens[51], TType::Op, (11, 15), (12, 15), "(" );
        test_token_w_position!(tokens[52], TType::Name, (12, 15), (16, 15), "self" );
        test_token_w_position!(tokens[53], TType::Op, (16, 15), (17, 15), ")" );
        test_token_w_position!(tokens[54], TType::Op, (17, 15), (18, 15), ":" );
        test_token_w_position!(tokens[55], TType::Newline, (18, 15), (19, 15), "\n" );
        test_token_w_position!(tokens[56], TType::Indent, (0, 16), (8, 16), "        " );
        test_token_w_position!(tokens[57], TType::Name, (8, 16), (14, 16), "return" );
        test_token_w_position!(tokens[58], TType::Name, (15, 16), (19, 16), "self" );
        test_token_w_position!(tokens[59], TType::Op, (19, 16), (20, 16), "." );
        test_token_w_position!(tokens[60], TType::Name, (20, 16), (21, 16), "c" );
        test_token_w_position!(tokens[61], TType::Newline, (21, 16), (22, 16), "\n" );
        test_token_w_position!(tokens[62], TType::Dedent, (0, 17), (0, 17), "" );
        test_token_w_position!(tokens[63], TType::Dedent, (0, 17), (0, 17), "" );
        test_token_w_position!(tokens[64], TType::EndMarker, (0, 17), (0, 17), "" );
    }
