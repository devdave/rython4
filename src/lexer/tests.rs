...
to see if it works""""#.to_string();
    ...
    fn test_basic_class() {
        ...
        test_token_w_position!(tokens[4], TType::Newline, (12, 1), (13, 1), "\n" );
        ...
        test_token_w_position!(tokens[7], TType::Newline, (7, 4), (8, 4), "\n" );
        test_token_w_position!(tokens[8], TType::NL, (0, 5), (1, 5), "\n" );
